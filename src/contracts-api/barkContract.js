...
import BarkContractMeta from '../../build/contracts/BarkMaker.json'
import contract from 'truffle-contract'

let instance = null

export default class BarkContract {
  constructor() {
    if (!instance) {
      instance = this
      this.web3 = getWeb3()
      this.contract = contract(BarkContractMeta)
  ...
  // async createChildContract(numberOfAds, influencerAddr) {
  //   const contractInstance = await this.contract.deployed()
  //   contractInstance.createNewBarkContract(numberOfAds, influencerAddr);
  // }
  //
  // async interactChildContract() {
  //
